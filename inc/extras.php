 ...
 * @since Manifest 2.0
 */
function manifest_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'manifest_page_menu_args' );
 ...
 * @since Manifest 2.0
 */
function manifest_enhanced_image_navigation( $url, $id ) {
...
add_filter( 'attachment_link', 'manifest_enhanced_image_navigation', 10, 2 );
