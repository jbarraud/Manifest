...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<h1 class="entry-title"><a href="<?php esc_attr_e( $link_url ); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'manifest' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
